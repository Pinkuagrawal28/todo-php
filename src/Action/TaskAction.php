<?php
    ...
    class TaskAction
    {
        ...
        public function mark()
        {
            ...
            echo <<<HTML
              <a hx-get="/task?action=mark&id={$this->id}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">
   {$buttonLabel}
    </a>
HTML;
        }
